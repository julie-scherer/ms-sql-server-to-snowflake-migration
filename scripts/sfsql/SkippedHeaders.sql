...
DELETE FROM STG.CREO_DatasetCell_HIST WHERE ASOFDATE = TO_DATE('2023-07-20');
...
-- LIST @ETL.INBOUND/CREO/Backfill/DatasetCell/


-- // TABLE 38: DatasetRow
DELETE FROM STG.CREO_DatasetRow_HIST WHERE ASOFDATE = TO_DATE('2023-07-20');
...
-- LIST @ETL.INBOUND/CREO/Backfill/DatasetRow/


-- // TABLE 39: MessageContactV2
DELETE FROM STG.CREO_MessageContactV2_HIST WHERE ASOFDATE = TO_DATE('2023-07-20');
...
DELETE FROM STG.CREO_PackageTemplate_HIST WHERE ASOFDATE = TO_DATE('2023-07-20');
