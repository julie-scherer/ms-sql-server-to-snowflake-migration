...
database1, database2, database3 = Utils.DATABASE1, Utils.DATABASE2, Utils.DATABASE3  # MSSQL databases and their tables

## Configurations for parallel processing
max_workers = Utils.MAX_WORKERS
timeout = datetime.timedelta(seconds=Utils.TIMEOUT_SECONDS)


## Function to log CLI output
# ! NOTE: not writing files on PC correctly
def log():
