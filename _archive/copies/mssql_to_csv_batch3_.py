...
def run_bcp_main(database_name, table_name, order_by, num_batches, src_tbl_dir, dst_tbl_dir):
    """
    ...
    for idx, database in enumerate(databases):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=max_workers) as executor:
            ...
            for idx, table_name in enumerate(table_names):
                ...
                num_batches = (row_count // batch_size) if not testing_small_batch else 2

                
                future = executor.submit(run_bcp_main, database_name, table_name, order_by, num_batches, src_tbl_dir, dst_tbl_dir)
